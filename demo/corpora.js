...
export const DEMO_TWITTER = {
  ...
  coverage: { timeline: true, likes: true, threads: 1, repairs: [], notes: [] },
  pipeline: {
    depth: 'standard',
    requests: 6,
    retries: 0,
  ...
  items: [
    ...
    { id: 'd6', kind: 'quote', createdAt: ago(8), likes: 640, reposts: 120, text: 'this is what people mean when they say something is "for the algorithm" — not that a machine wanted it, but that a person imagined a machine wanting it and made that instead\n\n> quoting @an_editor: the algorithm does not have taste. it has a preference, which is a different and much stupider thing' },
    {
      ...
      reposts: 505,
      parts: 4,
      text: '(1/4) i keep coming back to the difference between an audience and a witness.\n\n(2/4) an audience is a quantity. it can be grown, lost, optimised for. everything you make for it is a bid.\n\n(3/4) a witness is a person. they were there. they cannot be scaled and there is nothing to optimise.\n\n(4/4) most of the unhappiness i see online is someone who wanted witnesses and built an audience instead, and cannot work out why the numbers did not fix it',
    },
    ...
    { id: 'd22', kind: 'retweet', createdAt: ago(10), likes: 0, reposts: 0, via: 'an_editor', text: 'the enemy is not the phone. the enemy is the idea that every hour must be accounted for to somebody' },
