...
export const THEMES = [
  ...
  },
  {
    ...
    ids: ['milgram-obedience', 'stanford-prison-experiment', 'asch-conformity', 'bystander-effect',
      ...
      'russell-herd-instinct', 'russell-on-persecution', 'preference-falsification',
      'narcissism-of-small-differences', 'shigalyovism', 'the-public-sphere',
  ...
  },
  {
    ...
    ids: ['ring-of-gyges', 'bad-faith', 'moral-grandstanding', 'moral-licensing', 'akrasia',
      ...
      'radical-chic', 'luxury-beliefs', 'bootleggers-and-baptists', 'russell-on-persecution',
      'the-crystal-palace', 'smerdyakovs-inference', 'false-consciousness',
  ...
  },
  {
    ...
    ids: ['ends-and-means', 'feared-or-loved', 'machiavellian-virtu', 'state-of-nature',
      ...
      'pillars-of-support', 'political-jiu-jitsu', 'civil-resistance-threshold',
      'shigalyovism', 'the-vanguard-problem', 'chestertons-fence', 'the-knowledge-problem',
  ...
  },
  {
    ...
    ids: ['murderer-at-the-door', 'noble-lie', 'doublethink', 'newspeak', 'living-in-truth',
      ...
      'the-public-sphere', 'ideal-speech-situation', 'preference-falsification',
      'false-consciousness', 'the-crystal-palace'],
